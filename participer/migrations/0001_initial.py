# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-06-02 11:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ecole', models.CharField(max_length=50)),
                ('forfait', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='participer.forfait')),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='participer.equipe')),
            ],
        ),
        migrations.AddField(
            model_name='equipe',
            name='joueurs',
            field=models.ManyToManyField(to='participer.joueur'),
        ),
    ]
